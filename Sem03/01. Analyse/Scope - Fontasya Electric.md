...
- Bewijs voor alle 13 leeruitkomsten van mijn hoofdprofiel Management (Organizational Processes) — dit is voor mij niet onderhandelbaar, ongeacht hoe de teamscope zich ontwikkelt
...
- Pilotfase met gebruikers en verwerkte feedback (Fase 5) — versterkt vooral mijn D2-bewijs (PoC valideren)
- Signaleren van datakwaliteitsproblemen, modelbeperkingen en onzekerheden richting opdrachtgever (§5.2, §9.3)
- Documentatie en kennisoverdracht: datastroomoverzicht, technische architectuurbeschrijving, gebruikershandleiding (§4.4)
...
- Feedback van een externe professional of expert­tafel naast docenten en medestudenten
- Geautomatiseerde orchestration/scheduling van de dataketen

## Won't have (dit semester)
